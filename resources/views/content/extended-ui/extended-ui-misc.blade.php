...
<script src="{{asset('public/assets/vendor/libs/clipboard/clipboard.js')}}"></script>
<script src="{{asset('public/assets/vendor/libs/moment/moment.js')}}"></script>
<script src="{{asset('public/assets/vendor/libs/idletimer/idletimer.js')}}"></script>
<script src="{{asset('public/assets/vendor/libs/numeral/numeral.js')}}"></script>
