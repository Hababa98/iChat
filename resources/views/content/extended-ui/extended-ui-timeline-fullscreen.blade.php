...
<link rel="stylesheet" href="{{asset('public/assets/vendor/libs/animate-on-scroll/animate-on-scroll.css')}}" />
@endsection

@section('vendor-script')
<script src="{{asset('public/assets/vendor/libs/animate-on-scroll/animate-on-scroll.js')}}"></script>
@endsection
