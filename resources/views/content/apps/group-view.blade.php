...
@section('page-script')
    <script src="{{ asset('public/assets/js/group-view.js') }}"></script>
@endsection

@section('content')
    <div style="display: flex;justify-content: space-between;align-items: center">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Group /</span> View List
        </h4>
        <!-- Back Button -->
        <div class="justify-content-end">
            <div class="col-auto">
                <a href="{{ route('groups-list') }}" class="btn btn-secondary">Back</a>
            </div>
        </div>
    </div>
