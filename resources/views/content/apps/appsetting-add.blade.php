                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" id="name" value="{{ $appSetting['name'] }}"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label class="form-label" for="email">App Email<span
                                            style="color: red;">*</span></label>
                                    <input type="text" id="email" value="{{ $appSetting['email'] }}"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label class="form-label" for="server_key">App Notification Server Key<span
                                            style="color: red;">*</span></label>
                                    <input type="text" id="server_key" value="{{ $appSetting['server_key'] }}"
                                        placeholder="Enter App Server Key" name="server_key"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="text" name="text" rows="4" placeholder="Enter App Text"
                                    class="form-control @error('text') is-invalid @enderror">{{ $appSetting['text'] }}</textarea>
                                @error('text')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <!-- App Colour -->
                            <?php
                            // Assuming $appSetting['color'] contains RGB values in the format "52, 157, 249"
                            $rgb = explode(',', $appSetting['color']);
...
@enderror"
                            ...
                            <div class="mb-3" style="margin-top: 20px;">
                                ...
                                <div id="selectedImageContainer" style="padding-top: 10px;">
                                    ...
                                    <input type="hidden" name="existing_logo" value="{{ $appSetting['logo'] ?? '' }}">
                                    @if (isset($appSetting['logo']))
                                        <img src="{{ asset('public/assets/images/' . $appSetting['logo']) }}"
