        ...
        <div class="d-flex flex-column justify-content-center">
            <h5 class="mb-1 mt-3">Order {{ $data->OrderID }} <span class="badge bg-label-success me-2 ms-2">Paid</span>
                ...
                @elseif ($data->is_status == 3)
                    <span class="badge bg-label-primary">Onway</span>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-start align-items-center mb-4">
                        <div class="avatar me-2">
                            <img src="{{ asset('/assets/images/users_images/' . $data->image) }}" alt="Avatar"
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <select name="is_status" class="form-control" id="is_status">
                    ...
                    <option value="3"{{ $data->is_status == 3 ? 'selected' : '' }}>Onway </option>
                    <option value="0"{{ $data->is_status == 0 ? 'selected' : '' }}>Cancel</option>
                </select><br>
