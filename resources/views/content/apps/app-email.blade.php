...
@section('page-style')
    <link rel="stylesheet" href="{{ asset('public/assets/vendor/css/pages/app-email.css') }}" />
@endsection
...
@section('vendor-script')
    ...
    <script src="{{ asset('public/assets/vendor/libs/block-ui/block-ui.js') }}"></script>
@endsection
                ...
                <div class="card email-card-last mx-sm-4 mx-3 mt-4 border">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
                        <div class="d-flex align-items-center mb-sm-0 mb-3">
                            @if ($data->image)
                                <img src="{{ asset('/assets/images/users_images/' . $data->image) }}" alt="user-avatar"
