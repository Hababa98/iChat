...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">eCommerce /</span> Sub Category Edit
    </h4>
    ...
    <div class="app-ecommerce-category">
        ...
        <div class="offcanvas-body border-top">
          <form action="{{url('app/ecommerce/product/subcategory/update',$data->id)}}" enctype="multipart/form-data" method="post" class="pt-0">
              <!-- Title -->
              @csrf
              <div class="mb-3">
                  <label class="form-label" for="ecommerce-category-title">Title</label>
                  <input type="text" class="form-control" id="ecommerce-category-title"
                      placeholder="Enter sub category title" name="sub_category_name" aria-label="category title" value="{{$data->sub_category_name}}">
