...
class EcommerceProductSubCategory extends Controller
{
  public function index()
  {
    ...
    return view('content.apps.app-ecommerce-subcategory-list', compact('category'));
  }
  public function getSubCategoryListData(Request $request)
  {
    ...
    $totalRecordswithFilter = SubCategory::select('count(*) as allcount')->where('sub_category_name', 'like', '%' . $searchValue . '%')->count();

    $records = SubCategory::select('sub_categories.id', 'sub_categories.category_id', 'sub_categories.sub_category_name', 'sub_categories.sub_category_status', 'categories.category_name', 'categories.category_image')
  ...
  public function edit($id)
  {
    ...
    return view('content.apps.app-ecommerce-subcategory-edit', compact('data', 'category'));
  }
