        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<button class="btn btn-sm btn-icon delete-record" onclick="ReactivateUser(\'' +
              userId +
        ...
        success: function (response) {
          if (response.success) {
            ...
            Swal.fire({
              icon: 'error',
              title: 'Error',
              text: 'Failed to Reactivate User.',
              customClass: {
