        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $row_output =
              ...
              full['store_address'] +
              '</small>' +
              '<small class="text-muted"><b>Verified Stores:</b> ' +
              ...
              '</small>' +
              // '<span class="badge badge-pill badge-success"><i class="fas fa-check-circle"></i> <span>Verified</span></span>' +
              '</div>' +
              '</div>';
            return $row_output;
          }
...

        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<a href="javascript:0;" class="dropdown-item delete-record" id="store-deleted-' +
              full.id +
              '" onclick="deleteStore(' +
              full.id +
